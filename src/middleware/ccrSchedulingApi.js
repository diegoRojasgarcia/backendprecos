...
functionQueries.GetScheduleCCR = function (req, res) {//query encargada de obtener al usuario
connection.tx(function (t) {
...
functionQueries.GetScheduleRangeCCR = function (req, res) {//query encargada de obtener al usuario
